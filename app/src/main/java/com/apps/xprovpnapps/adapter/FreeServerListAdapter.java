...
public class FreeServerListAdapter extends RecyclerView.Adapter<FreeServerListAdapter.mViewhoder> {

    ArrayList<Country> datalist;
    private Context context;
    RemainingTraffic remainingTrafficResponse;
    public FreeServerListAdapter(ArrayList<Country> datalist, Context ctx) {
    ...
    {
        View item= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_server_list_free,parent,false);
